...
api_json_file = "hypixel_api_persistent.json"
api_response_games_file = "hypixel_games.json"
api_response_items_file = "hypixel_skyblock_items.json"
api_auctions_data_file = "auctions.json"
api_bazaar_data_file = "bazaar.json"
